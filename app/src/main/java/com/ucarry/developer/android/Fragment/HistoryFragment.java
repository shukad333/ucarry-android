...
public class HistoryFragment extends BaseFragment {
    ...
    private void preparenotificationData() {
        ...
        Call<List<SenderOrder>> call0 = ((MainActivity)getActivity()).apiService.getOrdersInProgress(null,"true");
        call0.enqueue(new Callback<List<SenderOrder>>() {
            ...
            public void onResponse(Call<List<SenderOrder>> call0, Response<List<SenderOrder>> response0) {
                ...
                Call<List<SenderOrder>> call = ((MainActivity)getActivity()).apiService.getSenderOrCarrierOrder("carrier", "schedules",null,"true");
...
//                   // Toast.makeText(getActivity(), "No problem"+ historyLists.get(0).getCarrier_schedule_detail().getMode(), Toast.LENGTH_LONG).show();
                        ...
                        Call<List<SenderOrder>> call1 = ((MainActivity)getActivity()).apiService.getSenderOrCarrierOrder("sender", "orders",null,"true");
